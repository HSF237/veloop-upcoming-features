"""
Process notify bell image: floodfill remove black background and copy transparent rocket.
"""
...
# Process Bell Icon
bell_src = r"C:\Users\HI\.gemini\antigravity-ide\brain\fb2ed9a7-e947-4640-9817-a9aa0014a3b2\media__1787235762865.jpg"
bell_out = r"public\assets\notify_bell_3d.png"

img_pil = Image.open(bell_src).convert("RGB")
...
out_img.save(bell_out)

print(f"Notify bell saved to {bell_out}")
