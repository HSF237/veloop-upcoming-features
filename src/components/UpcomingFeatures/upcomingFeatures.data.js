export const upcomingFeaturesData = [
  {
    ...
    category: "battle",
    type: "team-battle",
    videoUrl: "/videos/team-battle.webm",
    cta: "Stay Tuned",
    accent: "#ef4444",
    squadCurrent: 24,
    squadTotal: 50,
    squadReward: "50,000 VEs Pool",
    details: {
      ...
      highlights: [
        "Weekly Team Leaderboards & Rankings",
        "Co-op Earning Challenges & Team Quests",
        "Shared Bonus Prize Pools & Rank Multipliers"
      ],
      releasePhase: "Under Active Development · Estimated Phase 1 Launch"
    }
  },
  {
    id: "lucky-draw",
    ...
    category: "chance",
    type: "lucky-draw",
    videoUrl: "/videos/lucky-draw.webm",
    cta: "Stay Tuned",
    accent: "#d4af37",
    ticketText: "3 Free Tickets",
    ticketSub: "On Launch",
    details: {
      ...
      highlights: [
        "Daily Free Spins for Active Users",
        "Guaranteed Reward Tiers & Cashbacks",
        "Grand Jackpot Draws every Weekend"
      ],
      releasePhase: "Finalizing Prize Engine · Estimated Phase 1 Launch"
    }
  },
  {
    ...
    videoUrl: "/videos/milestone-rewards.webm",
    cta: "Stay Tuned",
    accent: "#3b82f6",
    milestoneCurrent: 3,
    milestoneMax: 5,
    milestoneUnlock: "Level 03 Unlocks",
    milestoneReward: "Legendary Chest",
    details: {
      ...
      highlights: [
        "Lifetime Engagement & Level Tracking",
        "Permanent Multiplier Boosts on Earnings",
        "VIP Status Trophies & Exclusive Badges"
      ],
      releasePhase: "QA Testing Phase · Estimated Launch Soon"
    }
  },
  {
    id: "collect-cards",
    ...
    videoUrl: "/videos/collect-cards.webm",
    cta: "Stay Tuned",
    accent: "#a855f7",
    collectedCount: 0,
    collectedTotal: 12,
    details: {
      ...
      highlights: [
        "Common, Rare, & Diamond Holographic Cards",
        "Card Trading Marketplace with Friends",
        "Full Set Completion Payouts & Bonuses"
      ],
      releasePhase: "Design System Phase · Stay Tuned"
    }
  },
  {
    id: "surprise-rewards",
    ...
    description: "Something amazing is waiting for you!",
    badge: "Under Development",
    category: "surprise",
    type: "surprise-gift",
    videoUrl: "/videos/surprise-gift.webm",
    cta: "Stay Tuned",
    accent: "#f59e0b",
    tagTitle: "Special Rewards",
    tagSub: "For You",
    details: {
      ...
      highlights: [
        "Random Activity Drop System",
        "Streak Multipliers & Double Point Passes",
        "Exclusive Mystery Partner Vouchers"
      ],
      releasePhase: "Backend Integration Phase · Under Development"
    }
  },
  {
    id: "mystery-rewards",
    ...
    description: "Unlock secret rewards with a mystery code.",
    badge: "Coming Soon",
    category: "mystery",
    type: "mystery-chest",
    videoUrl: "/videos/mystery-chest.webm",
    cta: "Stay Tuned",
    accent: "#06b6d4",
    placeholderCode: "Enter Secret Code",
    details: {
      ...
      highlights: [
        "Earn Keys via Eligible Tasks & Streaks",
        "Dynamic Chest Rarity & High Value Assets",
        "Instant Vault Unlocks & Rewards"
      ],
      releasePhase: "Game Logic Integration · Coming Soon"
    }
  },
  {
    ...
    description: "Invite friends, grow your network, and earn big together!",
    badge: "Launching Soon",
    category: "network",
    type: "referral-network",
    videoUrl: "/videos/referral-network.webm",
    cta: "Stay Tuned",
    accent: "#10b981",
    tier1: "1 Ref = 500 VEs",
    tier2: "5 Refs = 3,000 VEs",
    details: {
      ...
      highlights: [
        "Multi-tier Referral Milestone Payouts",
        "Passive Bonus Commission Scaling",
        "Referral Leaderboards & Special Badges"
      ],
